...
- By composing DockerImages of read-only layers, several containers of the same image can share all their common layers. This allows for each container only requiring a thin writable layer for updates, reducing the resource overhead of the containers.
